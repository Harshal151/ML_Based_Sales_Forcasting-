...
photo = PhotoImage(file="./images/csvupload.png")
...
photo5 = PhotoImage(file="./images/search1.png")
...
photo6 = PhotoImage(file="./images/select.png")
...
photo1 = PhotoImage(file="./images/predict.png")
...
photo2 = PhotoImage(file="./images/data_analysis.png")
...
photo4 = PhotoImage(file="./images/graph.png")
...
photo3 = PhotoImage(file="./images/database.png")
